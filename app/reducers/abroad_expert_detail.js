...
export default function (state=initialState, action) {
    ...
    switch (type) {
        ...
        case $.ABROAD_EXPERT_DETAIL_COMMENT_HASMORE_SET:
            return fromJS(newState).setIn(['comment', 'hasMore'], rest.hasmore).toJS();
        case $.ABROAD_EXPERT_DETAIL_COMMENT_CURR_SET:
        ...
        case $.ABROAD_EXPERT_DETAIL_SUMMARY_SET:
        ...
        case $.ABROAD_EXPERT_DETAIL_SERVICES_SET:
            return fromJS(newState).setIn(['detail', 'services'], rest.list).toJS();
        case $.ABROAD_EXPERT_DETAIL_COMMENT_FIRST_SET:
