        ...
        return (
            <ListView
                ...
                <View style={{marginBottom: 10}}>
                    {this._renderRow({
                        items: [
                            <View style={{flex: 1, marginRight: 5, alignItems: 'center', borderWidth: 1, borderColor: 'transparent'}}>
                            ...
                            <View style={{flex: 1, marginRight: 0, alignItems: 'center', borderWidth: 1, borderColor: 'transparent'}}>
                ...
                {items.map((b, i) => (
                    ...
                    <TouchableOpacity
                        ...
                        style={[
                            ...
                            i != items.length - 1 && {marginRight: 5},
