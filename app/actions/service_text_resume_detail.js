...
const _setRoot = (key, data) => _t($.SERVICE_TEXT_RESUME_SERVICE_DETAIL_ROOT_SET, {key, data});
const _setInner = (keys, data) => _t($.SERVICE_TEXT_RESUME_SERVICE_DETAIL_INNER_SET, {keys, data});
